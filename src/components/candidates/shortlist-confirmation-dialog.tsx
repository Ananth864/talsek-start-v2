...
type ShortlistConfirmationDialogProps = {
  open: boolean
...
/**
 * Confirm dialog for Shortlist — editable Reachout subject/body pre-filled
 * from the stage template (source `ShortlistConfirmationModal`).
 */
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        data-testid="candidate-shortlist-dialog"
      >
        <DialogHeader>
          <DialogTitle>Shortlist Candidate</DialogTitle>
          <DialogDescription>
            Review and send the Reachout message to {candidateName}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="shortlist-subject">Email Subject</Label>
            <Input
              id="shortlist-subject"
              value={messageSubject}
              onChange={(e) => onSubjectChange(e.target.value)}
              placeholder="Enter email subject…"
              data-testid="shortlist-subject"
            />
          </div>

          <div className="space-y-2">
            <Label htmlFor="shortlist-body">Email Message</Label>
            <Textarea
              id="shortlist-body"
              value={messageBody}
